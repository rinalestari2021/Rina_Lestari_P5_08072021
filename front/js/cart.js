...
removeItemBtns.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    // soit on recherge la page (ligne en dessous)
    window.location.reload() // refresh page after event and get new total // total price after items are deleted
    // soit on recalcule et reaffiche les totaux et le panier
